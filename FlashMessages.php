...
class FlashMessages {
    ...
    {
        return $this->add('<strong>Bravo ! </strong>'.$message, self::SUCCESS, $redirectUrl, $sticky);
    }
    ...
    {
        return $this->add('<strong>Attention : </strong>'.$message, self::WARNING, $redirectUrl, $sticky);
    }
    ...
    {
        return $this->add('<strong>Attention : </strong>'.$message, self::ERROR, $redirectUrl, $sticky);
    }
